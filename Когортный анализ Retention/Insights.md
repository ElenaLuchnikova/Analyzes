...
**!!!Конечные выводы об эффективности маркетинговых кампаний можно сделать только после проведения Когортного анализа выручки или прибыли (LTV), чтобы понять насколько они принесли пользу в финансовом плане. Человек может покупать часто, но на маленькие суммы, а для магазина важен именно доход от клиента.**
